        ...
        <?php
            if ($dbconn) {
                ...
                if (pg_fetch_array($result,null)) {
                    echo '<script>vaiAllaReg(" Spiacente, l indirizzo email non è disponibile  Se vuoi, <a href=../login/index.html> clicca qui per loggarti </a>");</script>';
                    ...
                    if ($data) {
                        echo '<script>vaiAllaReg("Registrazione completata. <a href=/login/index.html> Clicca qui </a>per loggarti!");</script>';
